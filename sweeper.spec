...
Version  : 24.12.3
Release  : 77
URL      : https://download.kde.org/stable/release-service/24.12.3/src/sweeper-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/sweeper-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/sweeper-24.12.3.tar.xz.sig
...
%setup -q -n sweeper-24.12.3
cd %{_builddir}/sweeper-24.12.3
pushd ..
cp -a sweeper-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742414334
mkdir -p clr-build
pushd clr-build
