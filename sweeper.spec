...
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/sweeper-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/sweeper-24.08.2.tar.xz.sig
...
%setup -q -n sweeper-24.08.2
cd %{_builddir}/sweeper-24.08.2
pushd ..
cp -a sweeper-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728569944
mkdir -p clr-build
pushd clr-build
