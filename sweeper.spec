...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/sweeper-21.12.0.tar.xz
...
%prep
%setup -q -n sweeper-21.12.0
cd %{_builddir}/sweeper-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639606502
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/sweeper-21.12.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/sweeper/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
pushd clr-build
%make_install
popd
%find_lang sweeper
