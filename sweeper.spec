...
Version  : 22.04.0
Release  : 37
URL      : https://download.kde.org/stable/release-service/22.04.0/src/sweeper-22.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.0/src/sweeper-22.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.0/src/sweeper-22.04.0.tar.xz.sig
...
%prep
%setup -q -n sweeper-22.04.0
cd %{_builddir}/sweeper-22.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650653088
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/sweeper-22.04.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/sweeper/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
pushd clr-build
%make_install
popd
%find_lang sweeper
