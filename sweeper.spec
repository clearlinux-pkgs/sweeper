...
Version  : 25.04.1
Release  : 79
URL      : https://download.kde.org/stable/release-service/25.04.1/src/sweeper-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/sweeper-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/sweeper-25.04.1.tar.xz.sig
...
%setup -q -n sweeper-25.04.1
cd %{_builddir}/sweeper-25.04.1
pushd ..
cp -a sweeper-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747073283
mkdir -p clr-build
pushd clr-build
