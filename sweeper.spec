...
Version  : 19.08.3
Release  : 13
URL      : https://download.kde.org/stable/applications/19.08.3/src/sweeper-19.08.3.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.3/src/sweeper-19.08.3.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.3/src/sweeper-19.08.3.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573199562
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/sweeper-19.08.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/sweeper/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang sweeper
