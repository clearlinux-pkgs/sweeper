...
Version  : 22.12.0
Release  : 45
URL      : https://download.kde.org/stable/release-service/22.12.0/src/sweeper-22.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/sweeper-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/sweeper-22.12.0.tar.xz.sig
...
%prep
%setup -q -n sweeper-22.12.0
cd %{_builddir}/sweeper-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670506590
mkdir -p clr-build
pushd clr-build
