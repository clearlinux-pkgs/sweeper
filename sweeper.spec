...
Source0  : https://download.kde.org/stable/release-service/19.12.3/src/sweeper-19.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.3/src/sweeper-19.12.3.tar.xz.sig
...
%prep
%setup -q -n sweeper-19.12.3
cd %{_builddir}/sweeper-19.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583528908
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/sweeper-19.12.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/sweeper/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang sweeper
