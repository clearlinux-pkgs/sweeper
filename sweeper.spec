...
Version  : 24.05.1
Release  : 66
URL      : https://download.kde.org/stable/release-service/24.05.1/src/sweeper-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/sweeper-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/sweeper-24.05.1.tar.xz.sig
...
%setup -q -n sweeper-24.05.1
cd %{_builddir}/sweeper-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718377493
mkdir -p clr-build
pushd clr-build
