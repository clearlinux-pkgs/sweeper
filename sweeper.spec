...
Version  : 20.08.0
Release  : 21
URL      : https://download.kde.org/stable/release-service/20.08.0/src/sweeper-20.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.0/src/sweeper-20.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.0/src/sweeper-20.08.0.tar.xz.sig
...
%prep
%setup -q -n sweeper-20.08.0
cd %{_builddir}/sweeper-20.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597801484
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/sweeper-20.08.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/sweeper/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang sweeper
